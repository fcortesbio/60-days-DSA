...
def run_validation_tests(
    functions: List[AlgorithmFunction], test_cases: List[TestCase], verbose: bool = True
    ...
    for test_case in test_cases:
        ...
        for function in functions:
            ...
            if verbose:
                print(
                    f"{result.function_name:{FUNCTION_NAME_WIDTH}} : "
        ...
        if verbose:
            status_text = (
                "✅ ALL TESTS PASSED" if test_case_passed else "❌ SOME TESTS FAILED"
            )
...
def _run_single_test(
    function: AlgorithmFunction, test_case: TestCase
) -> ValidationResult:
    """
...
def _print_validation_summary(
    results: List[ValidationResult], overall_passed: bool
) -> None:
    """
    ...
    for func_name, stats in function_stats.items():
        ...
        print(
            f"{status} {func_name:{FUNCTION_NAME_WIDTH}} : "
